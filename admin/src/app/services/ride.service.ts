...
export class RideService {
  ...
  getAllRides(): Observable<Ride[]> {
    return this.http.get<Ride[]>("/app/api/rides/", {
      headers: this.getHeader(),
    });
  }
  ...
  getRides(): Observable<Ride[]> {
    ...
    return this.http.get<Ride[]>("/app/api/rides/enabled", {
      headers: this.getHeader(),
    });
  }

  getRidesbyid(id_ride: number): Observable<Ride> {
    return this.http.get<Ride>("/app/api/rides/" + id_ride, {
      headers: this.getHeader(),
    });
  }

  getAllEnabledRidesByUser(): Observable<Ride[]> {
    return this.http.get<Ride[]>("/app/api/rides/enabledRidesByUser", {
      headers: this.getHeader(),
    });
  }

  getAllDisabledRidesByUser(): Observable<Ride[]> {
    return this.http.get<Ride[]>("/app/api/rides/disabledRidesByUser", {
      headers: this.getHeader(),
    });
  }

  getAllRidesJoinedByUser(): Observable<Ride[]> {
    return this.http.get<Ride[]>("/app/api/rides/ridesJoinedByUser", {
      headers: this.getHeader(),
    });
  }

  deleteRide(_id: any): Observable<Ride> {
    return this.http.delete<Ride>(`/app/api/rides/${_id}`, {
      headers: this.getHeader(),
    });
  }

  updateride(newRide: Ride): Observable<Ride> {
    return this.http.put<Ride>(`/app/api/rides/${newRide.id_ride}`, newRide, {
      headers: this.getHeader(),
    });
  }
  ...
  joinRide(id_ride: number): Observable<Ride> {
    return this.http.put<Ride>(
      "/app/api/rides/joinride/" + id_ride,
      {},
      { headers: this.getHeader() }
    );
  }
  ...
  unjoinRide(id_ride: number): Observable<Ride> {
    return this.http.put<Ride>(
      "/app/api/rides/unjoinride/" + id_ride,
      {},
      { headers: this.getHeader() }
    );
  }

  enableRide(id_ride: number): Observable<Array<number>> {
    return this.http.put<Array<number>>(
      `/app/api/rides/enable/${id_ride}`,
      {},
      {
        headers: this.getHeader(),
      }
  ...
  disableRide(id_ride: number): Observable<Array<number>> {
    return this.http.put<Array<number>>(
      `/app/api/rides/disable/${id_ride}`,
      {},
      {
        headers: this.getHeader(),
      }
